...
host_tree_trim1 = re.sub(r":\d\.\d+",r"",host_tree)
host_tree_trim = re.sub(r"\)\d+",r")", host_tree_trim1)
para_tree_f = open(args.parasite,'r')
para_tree = para_tree_f.read()
para_tree_trim1 = re.sub(r":\d\.\d+",r"",para_tree)
para_tree_trim = re.sub(r"\)\d+",r")", para_tree_trim1)
